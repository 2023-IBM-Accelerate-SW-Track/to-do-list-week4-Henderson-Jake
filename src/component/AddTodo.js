  ...
  handleSubmit = (event) => {
    ...
    if (this.state.content.trim()) {
      const jsonObject = {
        ...
        currentDate: this.state.date,    //value representing the date/time the task was added.
        dueDate: this.state.duedate             //value representing the time/date task is due.
      };
